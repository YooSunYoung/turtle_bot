...
class Bot:
    ...
    def __init__(self):
        ...
        self.course = [
            ...
            Checkpoint(latitude=5.069115, longitude= 126.864848, radius=5),
            
            Checkpoint(latitude=1.640280, longitude=122.914325, radius=150), 
            ...
            Checkpoint(latitude=-8.787996, longitude=115.728954, radius=5), 
            Checkpoint(latitude=-9.099064, longitude= 115.686013, radius=5),
